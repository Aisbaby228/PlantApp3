...
import 'package:rayshardenov_s_devochki2/presentation/my_lists_screen/movie_lists/Kazakh_films.dart';
import 'package:rayshardenov_s_devochki2/presentation/my_lists_screen/movie_lists/anime.dart';
...
class MovieLists extends StatelessWidget {
  ...
  /// Section Widget
  Widget _buildAnime(BuildContext context) {
    return Container(
      width: double.maxFinite,
      padding: EdgeInsets.symmetric(
        horizontal: 43.h,
  ...
  child: Text( "Anime",style: theme.textTheme.displayMedium,),
          )
  ...
  /// Section Widget
  Widget _buildKazakh(BuildContext context) {
    return Container(
      width: double.maxFinite,
      padding: EdgeInsets.symmetric(
        horizontal: 43.h,
  ...
  onTap: () {   Navigator.push( 
                                      context, 
                                      MaterialPageRoute( 
                                          builder: (context) => KazakhFilmsPage()));     },
  child: Text( "Kazakh films",style: theme.textTheme.displayMedium,),
          )
          )
        ],
      ),

...
import 'package:rayshardenov_s_devochki2/bottom_sheets/header_view8.dart';
...
class KazakhFilmsPage extends StatelessWidget {
  const KazakhFilmsPage({super.key});
    ...
    return Scaffold(
        body: SafeArea(
          ...
          child: Column(
            ...
            children: [
              // Header View
              Expanded(flex: 1, child: HeaderView8()),
